...
class ChangeHandler {
   ...
   * The parameter "type" is a string that is either 
   * quarter, dime, nickel, or penny
   */
  insertCoin(type) {
    if (type === "penny") {
      this.cashTendered += 1;
  ...
  /**
   * Returns true if enough coins have been inserted to at 
   * least meet the amountDue
   */
  isPaymentSufficient() {
